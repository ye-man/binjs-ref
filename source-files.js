...
sourcesIndex["binjs_io"] = {"name":"","dirs":[{"name":"binjs_json","files":["mod.rs","read.rs","write.rs"]},{"name":"bytes","files":["bool.rs","compress.rs","decoders.rs","float.rs","lengthwriter.rs","mod.rs","serialize.rs","strings.rs","varnum.rs"]},{"name":"entropy","dirs":[{"name":"read","files":["content_decoders.rs","mod.rs","prelude_decoders.rs"]},{"name":"write","files":["lazy_stream.rs","mod.rs"]}],"files":["baseline.rs","dictionary.rs","format.rs","mod.rs","predict.rs","probabilities.rs","rw.rs","util.rs"]},{"name":"io","files":["deprecated.rs","mod.rs","statistics.rs"]},{"name":"multipart","files":["mod.rs","read.rs","write.rs"]}],"files":["escaped_wtf8.rs","lib.rs","simple.rs","util.rs","xml.rs"]};
